// ========================================
// Copied from https://github.com/not-fl3/miniquad/blob/5575f037ba108c5ee4177d553c8776f995c4bac6/js/gl.js
...
var importObject = {
    env: {
		...
		// Changed from glUniform*v to glUniform*
        glUniform1f: function (location, x) {
            gl.uniform1f(GL.uniforms[location], x);
        },
        glUniform2f: function (location, x, y) {
            gl.uniform2f(GL.uniforms[location], x, y);
        },
        glUniform3f: function (location, x, y, z) {
            gl.uniform3f(GL.uniforms[location], x, y, z);
        },
        glUniform4f: function (location, x, y, z, w) {
            gl.uniform4f(GL.uniforms[location], x, y, z, w);
        },
        glUniform1i: function (location, x) {
            gl.uniform1i(GL.uniforms[location], x);
        },
        glUniform2i: function (location, x, y) {
            gl.uniform2i(GL.uniforms[location], x, y);
        },
        glUniform3i: function (location, x, y, z) {
            gl.uniform3i(GL.uniforms[location], x, y, z);
        },
        glUniform4i: function (location, x, y, z, w) {
            gl.uniform4i(GL.uniforms[location], x, y, z, w);
        },
